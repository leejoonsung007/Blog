...
$('#confirmBtn').click(function () {
    ...
    $.ajax({
        type: "DELETE",
        url: "http://ec2-52-201-210-120.compute-1.amazonaws.com" + ":8080/admin/note/" + id,
        success: function () {
            // refresh
            location.reload();
        }
...
$('#updateBtn').click(function () {
    ...
    $.ajax({
        type: "PUT",
        url: "http://ec2-52-201-210-120.compute-1.amazonaws.com" + ":8080/admin/note/" + noteId,
        dataType: "json",
...
$('#addNoteBtn').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "http://ec2-52-201-210-120.compute-1.amazonaws.com" + ":8080/admin/note/",
        dataType: "json",
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify(note),
        success: function () {
