...
$('#confirmBtn').click(function() {
	...
	$.ajax({
		type: "DELETE",
		url: "http://ec2-52-201-210-120.compute-1.amazonaws.com" + ":8080/admin/category/" + id,
		success: function() {
			// refresh
			location.reload();
		}
...
$('#addCategoryBtn').click(function() {
	...
	$.ajax({
		...
		url: "http://ec2-52-201-210-120.compute-1.amazonaws.com" + ":8080/admin/category",
...
$('#updateCategoryBtn').click(function() {
	...
	$.ajax({
		type: "PUT",
		url: "http://ec2-52-201-210-120.compute-1.amazonaws.com" + ":8080/admin/category/" + categoryId,
