...
document.writeln("			<span id=\'logo\' style=\'float: left;margin-left: 10px;\'><img src=\'../img/test4.jpg\'/></span>");
document.writeln("			<a href='../index.html'><span class=\"glyphicon glyphicon-home\"> HOME</a></span>");
document.writeln("			<a href=\'../blog.html\'><span class=\"glyphicon glyphicon-pencil\"> BLOG</a></span>");
document.writeln("			<a href=\'../about.html\'><span class=\"glyphicon glyphicon-user\"> ABOUT</a></span>");
document.writeln("			<a href=\'../resume.html\'><span class=\"glyphicon glyphicon-file\"> RESUME</a></span>");
...
document.writeln("					week = \'Wed\';");
document.writeln("					break;");
document.writeln("				case 4:");
document.writeln("					week = \'Thu\';");
document.writeln("					break;");
document.writeln("				case 5:");
document.writeln("					week = \'Fri\';");
document.writeln("					break;");
document.writeln("				case 6:");
document.writeln("					week = \'Sat\';");
document.writeln("					break;");
document.writeln("				default:");
document.writeln("					week = \'Sun\';");
document.writeln("			}");
...
document.writeln("			var ndate = days + \'-\' + month + \'-\' + years + \' \' + hours + \':\' + minutes + \':\' + seconds + \' \' + week;");
