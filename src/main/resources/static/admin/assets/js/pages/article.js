...
document.getElementById("articleCategories").onchange = function () {
    ...
    //	alert(categoryId);
    if (categoryId === "") {
        var url = "localhost" + ":8080/api/article/list";
    } else {
        var url =  "localhost" + ":8080/api/article/list/sort/" + categoryId;
    }
    // get category info
    $.ajax({
        url: url,
...
$('#confirmBtn').click(function () {
    ...
    $.ajax({
        type: "DELETE",
        url: "localhost" + ":8080/admin/article/" + id,
        success: function () {
            // refresh
            location.reload();
        }
...
$('#updateBtn').click(function () {
    ...
    $.ajax({
        type: "PUT",
        url: "localhost" + ":8080/admin/article/" + articleId,
        dataType: "json",
...
$('#addArticleBtn').click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "localhost" + ":8080/admin/article/",
        dataType: "json",
        contentType: "application/json;charset=utf-8",
        data: JSON.stringify(article),
        success: function () {
